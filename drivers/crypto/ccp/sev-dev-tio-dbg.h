...
#define __PSPR(x) case x: return #x
	...
	__PSPR(SEV_RET_INCORRECT_BUFFER_LENGTH);
	__PSPR(SEV_RET_EXPAND_BUFFER_LENGTH_REQUEST);
	__PSPR(SEV_RET_SPDM_REQUEST);
	__PSPR(SEV_RET_SPDM_ERROR);
	__PSPR(SEV_RET_SEV_STATUS_ERR_IN_DEV_CONN);
	__PSPR(SEV_RET_SEV_STATUS_INVALID_DEV_CTX);
	__PSPR(SEV_RET_SEV_STATUS_INVALID_TDI_CTX);
	__PSPR(SEV_RET_SEV_STATUS_INVALID_TDI);
	__PSPR(SEV_RET_SEV_STATUS_RECLAIM_REQUIRED);
	__PSPR(SEV_RET_IN_USE);
	__PSPR(SEV_RET_SEV_STATUS_INVALID_DEV_STATE);
	__PSPR(SEV_RET_SEV_STATUS_INVALID_TDI_STATE);
	__PSPR(SEV_RET_SEV_STATUS_DEV_CERT_CHANGED);
	__PSPR(SEV_RET_SEV_STATUS_RESYNC_REQ);
	__PSPR(SEV_RET_SEV_STATUS_RESPONSE_TOO_LARGE);
