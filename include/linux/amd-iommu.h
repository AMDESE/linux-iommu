...
extern int amd_iommu_update_ga(void *data, int cpu, bool posted_intr, int gappi_dest);
extern int amd_iommu_activate_guest_mode(void *data, int cpu, bool posted_intr, int gappi_dest);
...
static inline int amd_iommu_update_ga(void *data, int cpu, bool posted_intr, int gappi_dest)
{
	return 0;
}

static inline int amd_iommu_activate_guest_mode(void *data, int cpu, bool posted_intr, int gappi_dest)
{
	return 0;
}
