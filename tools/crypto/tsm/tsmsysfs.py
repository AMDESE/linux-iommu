...
def parse_report(data):
    ...
    print(f"dma_no_pasid={1 if (interface_info & (1 << 1)) else 0}")
    print(f"dma_pasid={1 if (interface_info & (1 << 2)) else 0}")
    print(f"ats={1 if (interface_info & (1 << 3)) else 0}")
    print(f"prs={1 if (interface_info & (1 << 4)) else 0}")
    print(f"msi_x_message_control={msi_x_message_control:#04x}")
    print(f"lnr_control={lnr_control:#04x}")
    print(f"tph_control={tph_control:#08x}")
    off = 16
...
def parse_tdi_status(data):
    ...
    print(f"meas_digest_valid={meas_digest_valid}")
    print(f"all_request_redirect={all_request_redirect}")
    print(f"bind_p2p={bind_p2p}")
    print(f"lock_msix={lock_msix}")
    print(f"no_fw_update={no_fw_update}")
    print(f"cache_line_size={cache_line_size}")
    print(f"algos=0x{spdm_algos:x}:{spdm_algos_to_str(spdm_algos)}")
    print(f"report_counter={intf_report_counter}")
